...
const projectDetails = [
  ...
  },
  {
    ...
    description:
      "This project is to develop a machine learning model that can accurately detect whether an essay was written by a student or an LLM. The dataset comprises a mix of student-written essays and essays generated by a variety of LLMs.",
    gitLink:
      "https://github.com/raghudungala/Machine-Learning/tree/main/llm-detect-ai-generated-text",
    skills: ["Python", "Pandas", "Numpy", "TensorFlow", "NTLK", "NLP"],
    logoPath: llmimage,
  },
  {
